System.registerModule("../es6/numbers.js", [], function() {
  "use strict";
  var __moduleName = "../es6/numbers.js";
  describe('Numbers', function() {
    ...
    it('should parse binary values with Number function ', function() {
      var binNum = Number("0b1101");
      expect(binNum).toBe(13);
    });
    it('should expose parseInt and pareFloat', function() {
